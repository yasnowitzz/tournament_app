...
export class TournamentStage1738497840844 implements MigrationInterface {
    name = 'TournamentStage1738497840844'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "match" ADD "stage" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "match" DROP COLUMN "stage"`);
    }
